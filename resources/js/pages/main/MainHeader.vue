    ...
    <header :class="{ 'scrolled': isScrolled }">
        <div class="header-container">
            ...
            <div class="header-actions">
                <!-- Telegram -->
                <a href="https://t.me/mikhaylova_evgenia" target="_blank" class="icon-btn" aria-label="Telegram">
                ...
                <!-- WhatsApp -->
                <a href="https://wa.me/+79025647339" target="_blank" class="icon-btn" aria-label="WhatsApp">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
